...
doc = nlp(u"Here is a test sentence for me to use.")
...
def parse_info(sentence):
    ...
    heads = [index + item[0] for index, item in enumerate(
        doc.to_array([HEAD]))
             ]
